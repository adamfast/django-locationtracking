...
class Migration:
    def forwards(self, orm):
        # Adding field 'PositionReport.point'
        db.add_column('locationtracking_positionreport', 'point', models.PointField(srid=4326, null=True, blank=True))

    def backwards(self, orm):
        # Deleting field 'PositionReport.point'
        db.delete_column('locationtracking_positionreport', 'point')
